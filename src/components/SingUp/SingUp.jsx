...
const Signup = () => {
  ...
  const API_LINK = "https://mpi-computer-club-backend.vercel.app/"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const usersResponse = await fetch("https://mpi-computer-club-backend.vercel.app/accounts/users/");
      if (!usersResponse.ok) {
      ...
      const registrationResponse = await fetch('https://mpi-computer-club-backend.vercel.app/accounts/register/', {
        method: 'POST',
        headers: {
