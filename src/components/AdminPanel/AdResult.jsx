...
const AdResult = () => {
  ...
  const fetchMarks = async () => {
    try {
      const response = await axios.get("https://mpi-computer-club-backend.vercel.app/classes/marks/");
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get("https://mpi-computer-club-backend.vercel.app/academics/students-list/");
  ...
  const fetchSubjects = async () => {
    try {
      const response = await axios.get("https://mpi-computer-club-backend.vercel.app/academics/subjects/");
  ...
  const addMark = async () => {
    try {
      ...
      await axios.post("https://mpi-computer-club-backend.vercel.app/classes/marks/", dataToSend);
  ...
  const updateMark = async () => {
    try {
      await axios.put(`https://mpi-computer-club-backend.vercel.app/classes/marks/${editingMark.id}/`, editingMark);
      fetchMarks();
      setEditingMark(null);
    } catch (error) {
  ...
  const deleteMark = async (id) => {
    try {
      await axios.delete(`https://mpi-computer-club-backend.vercel.app/classes/marks/${id}/`);
      fetchMarks();
    } catch (error) {
