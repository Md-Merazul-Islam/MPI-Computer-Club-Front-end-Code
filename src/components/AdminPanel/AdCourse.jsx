...
const AdCourse = () => {
    ...
    if (imageUrl) {
      try {
        ...
        const response = await axios.post(
          "https://mpi-computer-club-backend.vercel.app/academics/subjects/",
          newSubjectData
        );
    ...
    if (imageUrl) {
      try {
        ...
        const response = await axios.put(
          `https://mpi-computer-club-backend.vercel.app/academics/subjects/${editSubject.id}/`,
          updatedSubjectData
        );
  ...
  const deleteSubject = async (id) => {
    try {
      await axios.delete(`https://mpi-computer-club-backend.vercel.app/academics/subjects/${id}/`);
