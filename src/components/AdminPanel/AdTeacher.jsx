...
const AdTeacher = () => {
  ...
  const API_URL =
    "https://mpi-computer-club-backend.vercel.app/academics/teachers/";
...
const addTeacher = async () => {
  try {
    ...
    // Re-fetch the updated teachers list
    await fetchTeachers(); // Dynamically update state
    ...
    <div className="bg-white p-6 rounded-lg shadow-2xl max-w-lg w-full">
      ...
      <form
        onSubmit={(e) => {
          ...
          addTeacher(); // Call your custom function
        }}
      >
